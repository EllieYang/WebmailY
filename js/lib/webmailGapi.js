  ...
  function makeApiCall() {
      ...
      gapi.client.load('gmail','v1',function(){
        ...
        require(["js/lib/users.js"],function(getUser){
            ...
            //var spaceRequest = {"id":"space_request", "name":"New Connection Request", "subSpaces":[]};
            //var spaces = [];
            //spaces.push(spaceRequest);
            //change("spaces",spaces.concat(user1.space));
                ...
                if(lastMsg.payload){
                    lastMsg.payload.headers.forEach(function(header){
                        if((header.name == "Space-Fairy") && JSON.parse(header.value).state == true){
                            console.log(JSON.parse(header.value));
                            scope.$apply(function(){
